    ...
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-6 text-center pt-20">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="flex items-center justify-center gap-2 mt-4 text-xs text-gray-500 mb-8 sm:mb-16"
        >
          <span>Try:</span>
      ...
      <motion.div
        ...
        className="hidden sm:flex absolute bottom-10 left-1/2 -translate-x-1/2 flex-col justify-center items-center gap-2 "
      >
